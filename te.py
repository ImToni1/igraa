...
def game_loop():
    ...
    background_image = load_image("Pozadina.png", (800, 600))
    character_image = load_image("player1.png", (300, 300))
    house_image = load_image("home.jpg", (120, 120))
    portal_image = load_image("portal.png", (120, 120))
